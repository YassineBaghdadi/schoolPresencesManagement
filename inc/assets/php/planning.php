<?php
  ...
  if (isset($_POST['o'])) {
    ...
    if ($_POST['o'] == 'getPlanningData') {
      ...
      $qr = 'select s.id as sid, g.nme as gname, concat(t.fname, " ", t.lname) as tcher, t.module as mdl from
      PlanedSeassion s inner join Grps g on s.grp = g.id inner join Users t on s.tcher = t.id where ';
      ...
      $out = array('planningTable' => $planingTable, 'f' => $flrs);
